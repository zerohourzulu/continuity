...
import { derivePortableAdapterIdentity } from '../../../core-0.2/src/core/portable-integration.ts';
import { hashCanonical, immutableProtocolInput } from '../../../core-0.2/src/core/canonical.ts';
import { approvedPortableAdapterProfile, LOCAL_EVIDENCE_PACKET_ADAPTER_ID, createPortableAdapterAcknowledgment, portableAdapterAcknowledgmentEvidence, validatePortableAdapterAcknowledgment } from '../../../core-0.2/src/core/portable-adapter-engine.ts';
