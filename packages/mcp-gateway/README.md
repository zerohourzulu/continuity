...
- Shared Core's local profile allows at most256 history events. Capacity is finite; restarting or deleting records is not a supported way to recover capacity. No history pruning or migration is introduced here.
