...
[Release and downloads](https://github.com/zerohourzulu/continuity/releases/tag/v0.3.0-preview.7.6) · [Quickstart](docs/CORE-0.3-QUICKSTART.md) · [Shared packages](docs/SHARED-CORE.md) · [Remote tutorial](packages/remote-tools/README.md) · [Tests](docs/CORE-0.3-TESTING.md).
...
Source preview.7.6 adds the [local MCP gateway](docs/MCP-GATEWAY.md), npm preview.6. The original three packages and evidence listing stay unchanged. Consult the exact release and npm version for distribution availability. Public HTTP and a separate gateway Registry listing are deferred.
