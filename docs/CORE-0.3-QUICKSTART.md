...
Download and extract the complete [Core 0.3 preview](https://github.com/zerohourzulu/continuity/releases/tag/v0.3.0-preview.7.4). Verify its published SHA-256. From the extracted directory:
