...
The build emits `integrations/document-release-native/build/document_release.node`. Read the [native contract](../integrations/document-release-native/README.md) before the next step.
