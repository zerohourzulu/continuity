...
For a change to protocol behavior, public interfaces, security boundaries or compatibility, start with a short [RFC](docs/RFC.md) issue or draft pull request. Documentation, tests and focused fixes can go directly to a pull request. Maintainers discuss proposals in public, record the decision and its reasons, and review implementation separately. Forks are free to set their own direction under the applicable licenses.
