...
The reusable engine is [packages/core-0.2/src/core/index.ts](../source/packages/core-0.2/src/core/index.ts), version 0.2.2. The evaluation wrapper has its own version; it does not change Core's protocol version or fork the engine. `SOURCE-PROVENANCE.json` binds copied implementation files to their accepted source bytes.
...
| Concern | Source |
|---|---|
| Beginner orchestration | [tutorial/cli.mjs](../source/tutorial/cli.mjs) |
| Existing application, collection and handover | [application.mjs](../source/integrations/core-0.2-reference/src/application.mjs) |
| Durable intent admission and invocation | [durable-admission.ts](../source/packages/core-0.2/src/sdk/durable-admission.ts) |
| Local history | [portable-file-event-store.ts](../source/packages/core-0.2/src/indexer/portable-file-event-store.ts) |
| Fixed local packet executor | [packet-executor.mjs](../source/integrations/core-0.2-reference/src/packet-executor.mjs) |
| Typed executor acknowledgments | [portable-adapter-engine.ts](../source/packages/core-0.2/src/core/portable-adapter-engine.ts) |
...
[Optional native build](../source/docs/LINUX-LAB.md) · [Security boundaries](../source/SECURITY.md)
