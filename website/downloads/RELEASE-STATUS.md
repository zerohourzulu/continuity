...
Source preview.7.6 adds the [local MCP gateway](https://github.com/zerohourzulu/continuity/blob/main/docs/MCP-GATEWAY.md), npm preview.6. The original three packages and evidence listing stay unchanged. Consult the exact release and npm version for distribution availability. Public HTTP and a separate gateway Registry listing are deferred.
