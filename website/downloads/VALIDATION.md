...
> **0.3 preview note:** the prior release results below describe the unchanged 0.2.2 baseline, not validation of the new facade. See [the new interface and checks](https://github.com/zerohourzulu/continuity/blob/main/docs/CORE-0.3-API.md). This preview is local and has not been deployed or published to a registry.
...
[Run the checks yourself](https://github.com/zerohourzulu/continuity/blob/main/docs/TESTING.md) · [Security boundaries](https://github.com/zerohourzulu/continuity/blob/main/SECURITY.md).
