...
export function gatewayServer(gateway,{tasks=false}={}){
 const server=new McpServer({name:'continuity-mcp-gateway',version:JSON.parse(readFileSync(new URL('../package.json',import.meta.url),'utf8')).version},{capabilities:{tools:{},...(tasks?{extensions:{'io.modelcontextprotocol/tasks':{}}}:{})}});
