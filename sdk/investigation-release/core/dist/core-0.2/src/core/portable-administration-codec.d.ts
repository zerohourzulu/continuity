...
export type PortableAdministrativeTransitionEffect = (PortableDutyDispositionData & Readonly<{
    transitionEventType: "ATTEMPT_DUTY_DISPOSITION_RECORDED" | "ATTEMPT_DUTY_CONTEST_RECORDED";
}>) | Readonly<{
    transitionEventType: "ATTEMPT_DUTY_POLICY_ACTIVATED";
    actorId: string;
