...
export async function migrateDestinationHistory({directory,quiesced,expectedIdentity,hooks={}}){
  ...
  try{
    ...
    const {captureContinuationHistory,CONTINUATION_HISTORY_VERSION,exportContinuationEvents}=await import('@ramex-labs/continuity/adapter');
    const {createHistoryTransfer,openCheckpointStorage}=await import('@ramex-labs/continuity/adapter');
