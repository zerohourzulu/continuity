...
export declare function prepareContinuationAdministration(history: unknown, input: unknown): Readonly<{
    ...
    result: {
        transition: Readonly<{
            id: string;
            type: "OBLIGATION_CREATED" | "OBLIGATION_PERFORMANCE_ASSIGNED" | "OBLIGATION_STATUS_RECORDED" | "OUTCOME_OBSERVATION_RECORDED" | "ATTEMPT_DUTY_CREATED" | "ATTEMPT_DUTY_ASSIGNED" | "ATTEMPT_DUTY_REVIEW_CLOSED";
            timestamp: number;
