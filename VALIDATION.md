...
Not newly exercised: the optional native compilation/mechanics lab, a full multi-principal deployment, Windows, an x86 host, operational credentials, external agents, public blockchain execution, hostile-host behavior or public publication. Native guide observations are earlier retained evidence, clearly separate from these tutorial runs. No novice usability study or external assurance review was performed.
