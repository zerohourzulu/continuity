...
try{
 ...
 run('npm',['install','--ignore-scripts','--no-audit','--no-fund',join(root,'artifacts/ramex-labs-continuity-mcp-gateway-0.3.0-preview.6.tgz')]);
 ...
 assert.equal(meta.version,'0.3.0-preview.6');assert.notEqual(meta.private,true);
