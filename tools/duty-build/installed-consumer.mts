...
import {openLocalDutyPolicy,inspectContinuationDutyPolicy,type DutyPolicySelection,type DutyPolicyActivation,type PortableDutyPolicyDescriptor,type LocalDutyPolicy} from '@ramex-labs/continuity/duties';
...
async function consume() {
  ...
  if(result.view) {
    const status:'OPEN'=result.view.dutyDisposition;
    const outstanding:true=result.view.outstanding;
