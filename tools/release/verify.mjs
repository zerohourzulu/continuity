...
run([join(root,'tools/release/install.mjs'),consumer],root);
...
for(const name of ['duty-installed.mjs','duty-installed.mts'])cpSync(join(root,'tools/release',name),join(consumer,name));
