...
run([npm,'ci',...flags]);
const archive=join(source,'artifacts/ramex-labs-continuity-remote-0.3.0-preview.1.tgz');
...
if(process.env.CONTINUITY_CONSUMER_RECORD)writeFileSync(process.env.CONTINUITY_CONSUMER_RECORD,JSON.stringify({directory:consumer,node:process.version,package:'@ramex-labs/continuity-remote@0.3.0-preview.1',checks:['strict public types','signed walkthrough','native installed invocation']},null,2)+'\n');
