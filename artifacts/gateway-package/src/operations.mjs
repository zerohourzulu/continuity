...
import {PortableFileEventStore,stateOf,capacityOf,LOCAL_CAPACITY_PROFILE} from '@ramex-labs/continuity/adapter';
...
export function inspectCase({historyFile,storage}){
 ...
 const count=state.events.length,capacity=capacityOf(state.events);
